...
validators = {
    ('doctor_information', 'POST'): {'json': {'type': 'object', 'required': ['name', 'location', 'specialization', 'gender'], 'properties': {'name': {'type': 'string'}, 'location': {'type': 'string'}, 'specialization': {'type': 'string'}, 'gender': {'type': 'string'}}}},
    ('doctor_getinformation', 'GET'): {'args': {'required': ['doctorName'], 'properties': {'doctorName': {'description': 'The doctor name', 'type': 'string'}}}},
}

filters = {
    ('doctor_information', 'POST'): {200: {'headers': None, 'schema': None}},
    ('doctor_getinformation', 'GET'): {200: {'headers': None, 'schema': None}, 400: {'headers': None, 'schema': None}},
    ('doctor_available', 'GET'): {200: {'headers': None, 'schema': None}},
}
